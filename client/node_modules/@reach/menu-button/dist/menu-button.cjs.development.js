...
var MenuDescendantContext = /*#__PURE__*/descendants.createDescendantContext("MenuDescendantContext");
var MenuContext = /*#__PURE__*/utils.createNamedContext("MenuContext", {});
var initialState = {
...
var Menu = function Menu(_ref) {
  ...
  var menuId = id || utils.makeId("menu", _id); // We use an event listener attached to the window to capture outside clicks
  ...
  utils.useCheckStyles("menu-button");
  return React.createElement(descendants.DescendantProvider, {
...
var MenuButton = /*#__PURE__*/utils.forwardRefWithAs(function MenuButton(_ref2, forwardedRef) {
...
var MenuItemImpl = /*#__PURE__*/utils.forwardRefWithAs(function MenuItemImpl(_ref3, forwardedRef) {
  var Comp = _ref3.as,
...
var MenuItem = /*#__PURE__*/utils.forwardRefWithAs(function MenuItem(_ref4, forwardedRef) {
...
var MenuItems = /*#__PURE__*/utils.forwardRefWithAs(function MenuItems(_ref5, forwardedRef) {
  ...
  var menuItems = descendants.useDescendants(MenuDescendantContext);
  ...
  var handleKeyDown = utils.wrapEvent(function handleKeyDown(event) {
    var key = event.key;
    ...
    switch (key) {
      ...
      default:
        ...
        // the query state.
        if (utils.isString(key) && key.length === 1) {
  ...
  }, descendants.useDescendantKeyDown(MenuDescendantContext, {
...
var MenuLink = /*#__PURE__*/utils.forwardRefWithAs(function MenuLink(_ref6, forwardedRef) {
...
var MenuList = /*#__PURE__*/utils.forwardRefWithAs(function MenuList(_ref7, forwardedRef) {
...
var MenuPopover = /*#__PURE__*/utils.forwardRefWithAs(function MenuPopover(_ref8, forwardedRef) {
  ...
  return portal ? React.createElement(popover.Popover, Object.assign({}, commonProps, {
    as: Comp,
    targetRef: buttonRef,
    position: position
  })) : React.createElement(Comp, Object.assign({}, commonProps));
});
...
function useMenuItemId(index) {
  var _React$useContext6 = React.useContext(MenuContext),
      menuId = _React$useContext6.menuId;

  return index != null && index > -1 ? utils.makeId("option-" + index, menuId) : undefined;
}
